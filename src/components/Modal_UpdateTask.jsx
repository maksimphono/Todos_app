...
export default function Modal_NewTask(props){
    ...
    const onSubmit = event => {
        ...
        UPDATE_task(JSON.stringify({todoIndex, title, description}));
            ...
            <Modal.Body>
                <Form onSubmit = {onSubmit}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <Form.Control id="task_title" controlId="task_title" type="text" value={props.title} />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Edit task Description:</Form.Label>
                        <Form.Control id="task_description" controlId="task_description" as="textarea" value={props.description} />
                    </Form.Group>
